...
namespace Projekt
{
    internal class GlCube : GlObject
    {
        ...
        //itt a textura = null kene legyen
        ...
        {
            //opcionalisan lehet megadni a texturat
            Texture = texture;
        }
        ...
        public static unsafe GlCube CreateInteriorCube(GL Gl, string textureResourceId)
        {
            ...
            //utolso 2 szam u v koordinat - a textura doboz koordinataja x y ban
            // counter clockwise is front facing
            float[] vertexArray = new float[] {
                // top face //az elso bal felul van a hatunk mogott
            ...
            uint vertexSize = offsetTexture + (2 * sizeof(float));  //plusz 2 index minden csomoponthoz
            ...
            //textura koodinatait adjuk hozza - a szinezest kivettuk
            Gl.EnableVertexAttribArray(2);
            Gl.VertexAttribPointer(2, 3, VertexAttribPointerType.Float, false, vertexSize, (void*)offsetNormal);
            ...
            var skyboxImageResult = ReadTextureImage("skybox.jpeg");
